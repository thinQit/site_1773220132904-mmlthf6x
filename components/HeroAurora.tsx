...
export default function HeroAurora({
  ...
  subheadline = 'High-intensity classes, elite coaching, and a community that pushes you past limits.',
  ...
  return (
    <AuroraBackground auroraColors={['#ef4444', '#f97316', '#f87171', '#fca5a5', '#fb7185']}>
      ...
      >
        ...
        <TextGenerateEffect
          words={headline}
          className="text-4xl font-bold text-center tracking-tight uppercase text-foreground sm:text-5xl md:text-6xl lg:text-7xl max-w-4xl"
        />
