...
export default function TeamGrid({
  ...
  subheadline = 'Certified trainers focused on form, intensity, and sustainable progress.',
  members = [],
      ...
      <div className="container mx-auto max-w-7xl px-4">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {members.map(function (member, i) {
            return (
              <Card key={i} className="card-hover overflow-hidden rounded-xl border border-border bg-card text-center shadow-sm">
                {member.imageUrl && (
                ...
                <CardContent className="p-5">
                  <h3 className="text-lg font-semibold uppercase text-foreground">{member.name}</h3>
